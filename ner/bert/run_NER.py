...
flags.DEFINE_string(
    "output_dir", '/content/drive/My Drive/bert-ner-xiandai/output',
    "The output directory where the model checkpoints will be written.")

## Other parameters

flags.DEFINE_string(
    "init_checkpoint", '/content/drive/My Drive/bert-ner-xiandai/bert-model/bert_model.ckpt',
    ...
    def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            def metric_fn(per_example_loss, label_ids, logits):
                ...
                precision = tf.metrics.accuracy(label_ids, predictions)
                recall = tf.metrics.recall(label_ids, predictions)
                f = tf_metrics.f1(label_ids, predictions, 10)
                recall = tf.metrics.recall(label_ids, predictions)
